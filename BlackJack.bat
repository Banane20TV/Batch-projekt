...
echo                     º   1. Play         2. About       º
echo                     º   3. Tutorial     4. Configure   º
echo                     º   5. Bank         6. Shop        º
echo                     º   7. Reset        8. Spint       º
...
echo                         BlackJack                    º±±±±±±±º
echo                                                      º±B±±±±±º
echo                       By TheCoder TV                 º±±±±±±±º
echo                                                      º±±±±±±º
echo                     Copyright (c) 2019               º±±±±±±±º
echo                                                      º±±±±±B±º
echo                                                      º±±±±±±±º
echo                                                      ÈÍÍÍÍÍÍÍ¼
echo.
...
set pcard2bar=ÉÍÍÍÍÍÍÍ»
set pcard2bar2=ÈÍÍÍÍÍÍÍ¼
set set8bar=
set set8bar2=
if not '%set8%' == 'onÄÄÄ' (
...
set vv9=º±±±±±±±º
set dcg2=º±±±±±±º
set set8bar=ÉÍÍÍÍÍÍÍ»
set set8bar2=ÈÍÍÍÍÍÍÍ¼
)
set soft=
set bustfix=
set insurancetext=
...
set pcg1=º±±±%r%±±±º
if '%r%' == '10' set pcg1=º±±±10±±º
if '%r%' == '11' set face=J
if '%r%' == '12' set face=Q
if '%r%' == '13' set face=K

call :suit
if '%r%' == '1' set pcg1=º±±±%suit%±±±º
...
if '%r%' == '1' set /a pacecount=%pacecount%+1
set pcg2=º±±±%r%±±±º
if '%r%' == '10' set pcg2=º±±±10±±º
if '%r%' == '11' set face=J
if '%r%' == '12' set face=Q
if '%r%' == '13' set face=K
call :suit
if '%r%' == '1' set pcg2=º±±±%suit%±±±º
if '%split%' == 'true' (
set poncard=3
goto pcard2end)
...
if '%r%' == '1' set dcg1=º±±±%suit%±±±º

if '%dcard1%' == '11' set i=yes
if '%set3%' == 'onÄÄÄ' set i=

if '%set8%' == 'onÄÄÄ' goto skipdcard2
:dcard2
set doncard=2
set /A r=%RANDOM% %% 13 + 1
...
if '%set3%' == 'onÄÄÄ' (
set dcg2=º±±±%r2%±±±º
if '%r2%' == '10' set dcg2=º±±±10±±º
if '%r2%' == '11' set face=J
if '%r2%' == '12' set face=Q
if '%r2%' == '13' set face=K
call :dsuit
if '%r2%' == '1' set dcg2=º±±±%suit%±±±º

set hidden=%dcard2%
set hiddenplus=
)
if '%set8%' == 'onÄÄÄ' call :setnatural
if '%set8%' == 'onÄÄÄ' exit /b
...
:natural
if not '%set8%' == 'onÄÄÄ' set /a dealernatural=%dcard1%+%dcard2%
...
echo.
echo   ÉÍÍÍÍÍÍÍ»  %set8bar%  %dc3r1%  %dc4r1%  %dc5r1%  %dc6r1%
...
echo   ÈÍÍÍÍÍÍÍ¼  %set8bar2%  %dc3r2%  %dc4r2%  %dc5r2%  %dc6r2%
echo.
echo                     Bet:$%bet% %splitbettext% %insurancebettext%
echo.
echo   ÉÍÍÍÍÍÍÍ»  ÉÍÍÍÍÍÍÍ»  %c3r1%  %c4r1%  %c5r1%  %c6r1%
...
echo   ÈÍÍÍÍÍÍÍ¼  ÈÍÍÍÍÍÍÍ¼  %c3r2%  %c4r2%  %c5r2%  %c6r2%
echo.
echo Money: $%playermoney%
...
if '%dnatcomp%' == 'yes' (
if '%set3%' == 'onÄÄÄ' set flip2=true
if '%set3%' == 'onÄÄÄ' goto play
set dcg2=º±±±%r2%±±±º
if '%r2%' == '10' set dcg2=º±±±10±±º
if '%r2%' == '11' set face=J
if '%r2%' == '12' set face=Q
...
set drawsound=true
if '%set7%' == 'onÄÄÄ' call :previousscreen
set pcg%poncard%=º±±±%r%±±±º
if '%r%' == '10' set pcg%poncard%=º±±±10±±º
if '%r%' == '11' set face=J
if '%r%' == '12' set face=Q
if '%r%' == '13' set face=K
if '%r%' == '11' set r=10
...
if '%set9%' == 'onÄÄÄ' if %dcardvalue% GEQ %pcardvalue% goto compare
if '%split%' == 'true' (
if '%set9%' == 'onÄÄÄ' if %dcardvalue% GEQ %spvalue% goto compare
)

if '%set1%' == 'onÄÄÄ' if %dcardvalue% GEQ 17 (
...
set drawsound=true
if '%set7%' == 'onÄÄÄ' call :previousscreen
set dcg%doncard%=º±±±%r%±±±º
if '%r%' == '10' set dcg%doncard%=º±±±10±±º
if '%r%' == '11' set face=J
if '%r%' == '12' set face=Q
if '%r%' == '13' set face=K
if '%r%' == '11' set r=10
...
REM SPLIT PUSH######################
if not '%set5%' == 'onÄÄÄ' goto splitpushskip
...
echo            º                                                      º
echo            º 1. Dealer can hit past 17                       %set1%¶
echo            º                                                      º
echo            º 2. Dealer hits on a soft 17                     %set2%¶
echo            º                                                      º
echo            º 3. Dealer's hole card is face up                %set3%¶
echo            º                                                      º
echo            º 4. Splitting                                    %set4%¶
echo            º                                                      º
echo            º 5. Dealer wins ties                             %set5%¶
echo            º                                                      º
echo            º 6. Hit or DoubleDown split aces                 %set6%¶
echo            º                                                      º
echo            º 7. Sounds                                       %set7%¶
echo            º                                                      º
echo            º 8. No hole card                                 %set8%¶
echo            º                                                      º
echo            º 9. Dealer may stand whenever                    %set9%¶
echo            º                                                      º
echo            º 10. Set Min/Max bet                                  º
echo            º                                                      º
echo            º                                                      º
echo            º        b/Go Back  d/Defaults  h/Settings Help        º
echo            ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼
echo.
set /p choose=Choose a number to change the setting: 
if '%choose%' == '1' (
if '%set1%' == 'offÄÄ' (set set1=onÄÄÄ) ELSE set set1=offÄÄ
)

if '%choose%' == '2' (
if '%set2%' == 'offÄÄ' (set set2=onÄÄÄ) ELSE set set2=offÄÄ
)
...
if '%choose%' == '4' (
if '%set4%' == 'offÄÄ' (set set4=onÄÄÄ) ELSE set set4=offÄÄ
)

if '%choose%' == '5' (
if '%set5%' == 'offÄÄ' (set set5=onÄÄÄ) ELSE set set5=offÄÄ
)

if '%choose%' == '6' (
if '%set6%' == 'offÄÄ' (set set6=onÄÄÄ) ELSE set set6=offÄÄ
)

if '%choose%' == '7' (
if '%set7%' == 'offÄÄ' (set set7=onÄÄÄ) ELSE set set7=offÄÄ
)
...
if '%choose%' == '9' (
if '%set9%' == 'offÄÄ' (set set9=onÄÄÄ) ELSE set set9=offÄÄ
)
...
echo                     Bet:$%bet% %splitbettext% %insurancebettext%
echo.
echo   ÉÍÍÍÍÍÍÍ»  %pcard2bar%  %c3r1%  %c4r1%  %c5r1%  %c6r1%
echo   %u1%%u2%  %v1%%v2%  %w1%%w2%  %x1%%x2%  %y1%%y2%  %z1%%z2%
echo   %u3%  %v3%  %w3%  %x3%  %y3%  %z3%
echo   %u4%%u5%  %v4%%v5%  %w4%%w5%  %x4%%x5%  %y4%%y5%  %z4%%z5%
echo   %pcg1%  %pcg2%  %pcg3%  %pcg4%  %pcg5%  %pcg6%
...
echo   %u8%  %v8%  %w8%  %x8%  %y8%  %z8%
echo   %u9%%u10%  %v9%%v10%  %w9%%w10%  %x9%%x10%  %y9%%y10%  %z9%%z10%
echo   ÈÍÍÍÍÍÍÍ¼  %pcard2bar2%  %c3r2%  %c4r2%  %c5r2%  %c6r2%
echo.
echo Money: $%playermoney%
echo Your cards: %pcard1%,%pcard2%,%pcard3%,%pcard4%,%pcard5%,%pcard6% = %pcardvalue% %status1%
%splittext% %status2%
...
echo                                º                                      º
echo                     _.---------º.--.     How to play BlackJack        º
echo                  .-'  `       .'/  ``  --------------------------     º
echo               .-'           .' ^|    /^|                                º
echo            .-'         ^|   /   `.__//       1 The Basics             º
echo         .-'           _.--/        /                                  º
echo        ^|        _  .-'   /        /         2 Side Rules             º
echo        ^|     ._  \      /     `  /                                    º
echo        ^|        ` .    /     `  /           3 Settings               º
echo        ^|         \ \ '/        /                                      º
echo        ^|        - \  /        /º            4 Other Notes            º
echo        ^|        '  .'        / º                                      º
echo        ^|          '         ^|.'º                                      º
echo        ^|                    ^|  º          Type "b" to go back         º
echo        ^|                    ^|  º                                      º
...
echo               _NN`              ,__NNN"""""        """""NNL__.              ´NN_               
echo             _NF`             _JNF""                        ""4NL_             ´4N_             
echo           ,NF`            _NN"                                 ´"NN_.           ´4N.           
echo         ,JN"             "NL.                                     ´"NN_           "NL.         
echo        ,NF                 "N_                                       ´4N_.          4N_        
echo       JN`                    4N_                                       ´4NL          ´NL       
echo      JN`                      ´4N_                                       ´4N_         ´NL      
echo     _F`         _.              ´4N_                                       ´N_         ´4L     
echo    ,N`         JNNL.              ´4N_                                       NL         ´NL    
echo   ,NF         JN` "NL.              ´4N_                                     ´NN.        (N.   
echo   NN         JF     "N_.              ´4N.                                     4N.        4N.  
echo  JN`        JN`       "NL.              ´NL.                                    NL        ´NL  
echo ,NF        JN`          "NL.              "NL.                                  ´NL        (N) 
echo JN        ,NF             "NL               "NL.                                 (N.        NN 
echo ,N)        JN                "L_               "NL.                                NL        (N.
echo (N`        NF                 ´4N_               "NL.                              (N.        N)
echo NN        (N)                   ´4L_               "NL                             ´N)        NN
echo NN        (N                      ´4N_               "N_                            N)        NN
echo NN        (N                        ´4L_              ´4N_                          N)        NN
echo NN        (N                          ´4N_              ´4N_                        NN        NN
echo NN        (N                            ´4L.              ´4N_                      N)        NN
echo NN        (N)                             "NL.              ´4N_                   (N)        NN
echo (N)        NL                               "NL.              ´4N_                 (N`       ,N)
echo NL        (N.                                "NL.              ´4L.               NF        (N`
echo 4N.       ´NL                                  "NL.              "NL.            JN`        NF 
echo ´NL        (N)                                   "NL.              "NL.         ,N)        (N` 
echo  (N.        4N.                                    "N_               "NL.      ,NF        ,NF  
echo   NN         4N.                                     4N_               "NL.   ,NF         JN   
echo   ´NL         4N.                                     ´4L_               "NL.,NF         JN`   
echo    ´N.         ´N.                                      ´4N_               "NNF         ,N`    
echo     ´N.         ´N_                                       ´4L_               `         ,N`     
echo      4N.         ´4N_                                       ´4N_                      ,NF      
echo       ´NL          ´4N_                                       ´4L.                   JN"       
echo        ´4N.          "NN_                                       ´NL.               ,JN`        
echo          "NL           ´"NL_                                      NNL             _N"          
echo           ´4N_            ´4N__                                __NF"            _NF`           
echo             ´4N_             ""NNL__                      __JNN""             _NF`             
echo               ´4N_               ´""4NNN______________JNNF"""               _NF`               
echo                  4NL_                   ´""""""""""""`                   ,_NF                  
echo                    "4N__                                              ,_NF"                    
echo                       "4NL_.                                      ,__NF"                       
echo                          ´""NL__.                             __JNF"`                          
echo                              ´""4NNL____.             ____JNNF""`                              
echo                                     """""NNNNNNNNNNNN"""""                                     
echo.
echo.
ping -n 3 localhost >NUL
